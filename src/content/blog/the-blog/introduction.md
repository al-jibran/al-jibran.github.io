...
There is a point to these stories beyond filling out an introduction.

Looking back, they represent two sides of my experience with software. The first is the joy of building things myself and the other is the frustration of not knowing something and having no idea where to start.
...
- __Things the tutorials would mention in passing__: When and how do you cache? What's a migration? SSL? Git? Command Line? Scripting? How do you deploy? SSH? How do you "use" a domain?

- __Things that were theoretical and boring on their own__: Architectural patterns, software design patterns, system design, how to write readable code? When do data structures and algorithms matter outside of an interview question?
...
I hope this blog can be beneficial to someone. Maybe someone who is expected to have the skills of a mid-level or even senior developers while still being a junior or newcomer. Maybe someone who wants to reignite their love of coding again.

## Take off

I will have more to say about burnout, the missing pieces, AI, abstractions, and software in general. 
